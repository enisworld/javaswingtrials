...
public class SideViewPanel extends JComponent implements MouseListener, MouseMotionListener{
...
*/		
	...
	public void mouseMoved(MouseEvent e) {
		System.out.print("Side View Panel Move event ===> ");
		System.out.println("Points : X - Y : " + e.getX() + " - "+ e.getY());
	...
	public MShape createCurrentMShape(Point start, Point end) {
		currentShape = new MCylinder(start.x, start.y, Math.abs((start.x - end.x)), Math.abs((start.y - end.y)));
		return currentShape;
	}
